...
# class Npkreadings(models.Model):
#     id =models.AutoField(primary_key=True)
#     farmer_id =models.IntegerField()
#     sensor_id = models.IntegerField()
#     npk_readings =models.IntegerField()
#     recommendation_id =models.ForeignKey(Recommendations,on_delete=models.CASCADE,related_name='recommendation_content')
    
    
#     def __str__(self):
#         return f"{self.npk_id}"
